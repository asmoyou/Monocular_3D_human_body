...
if os.name == "nt":
    # pyrender's OffscreenRenderer only supports pyglet on Windows when the
    # PyOpenGL platform variable is *unset*. Some third-party libs set it to
    # other backends (e.g. pyglet/win32), which causes pyrender to refuse
    # initialization. Clear it so pyrender can pick its default (pyglet).
